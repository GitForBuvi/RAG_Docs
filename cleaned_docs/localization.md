...
First, create your own fork of the
...
labels: A list of GitHub labels to automatically apply to a PR, in this
  case, the language label created in Configure the workflow.
...
Publicizes the localization's availability through
  ...
  channels, including the Kubernetes blog.
...
-----|-----
Latest version | main
Previous version | release-{{< skew prevMinorVersion >}}
Next version | dev-{{< skew nextMinorVersion >}}
...
For example, see the
Korean Localization Guide, which
...
Your team approvers joined the @kubernetes/website-maintainers team when
   you added your localization team to
   the kubernetes/org repository.
