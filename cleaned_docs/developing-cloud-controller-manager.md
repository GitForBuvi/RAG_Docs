...
Import your cloud package in main.go, ensure your package has an init block to run cloudprovider.RegisterCloudProvider.
...
In tree
For in-tree cloud providers, you can run the in-tree cloud controller manager as a {{< glossary_tooltip term_id="daemonset" >}} in your cluster. See Cloud Controller Manager Administration for more details.