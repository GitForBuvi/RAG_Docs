...
Kubernetes offers a built-in Pod Security {{< glossary_tooltip text="admission controller"
...
object such as a {{< glossary_tooltip
term_id="deployment" >}} or {{< glossary_tooltip term_id="job">}}. The workload object defines a
Pod template and a {{< glossary_tooltip term_id="controller" text="controller" >}} for the
