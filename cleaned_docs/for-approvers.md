...
Kubernetes code review process.
...
silently ignored.
For a list of all labels, see the website repository's Labels section.
...
You can send a link to article updates and maintenance
...
Opening pull requests and squashing your commits
...
The kubernetes/website repo is
  configured to allow squashing for pull request merges.
