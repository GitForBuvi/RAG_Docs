...
| Direct Server Return (DSR) | See DSR notes above. | Windows Server 2019 | Set the following command line argument (assuming version {{< skew currentVersion >}}): --enable-dsr=true |
