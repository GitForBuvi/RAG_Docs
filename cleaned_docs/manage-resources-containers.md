...
When you specify a resource limit for a container, the {{< glossary_tooltip text="kubelet" term_id="kubelet" >}} enforces those 
...
Read how the API reference defines a container
