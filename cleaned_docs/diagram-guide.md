...
direction TB
S[ ]-.-
C[builddiagramswith markdown] -->
D[on-linelive editor]
end
A[Why are diagramsuseful?] --> m
m --> N[3 x methodsfor creatingdiagrams]
N --> T[Examples]
T --> X[Stylingandcaptions]
X --> V[Tips]
...
graph TB
A[Contributor]
B[InlineMermaid codeadded to .md file]
C[Mermaid+SVGAdd mermaid-generatedsvg file to .md file]
D[External toolAdd external-tool-generated svg fileto .md file]
A --> B
A --> C
A --> D
...
{{< mermaid >}}
graph LR
A[1. Use live editor to create/editdiagram] -->
B[2. Store diagramURL somewhere] -->
C[3. Copy Mermaid codeto page markdown file] -->
D[4. Add caption]
classDef box fill:#fff,stroke:#000,stroke-width:1px,color:#000;
class A,B,C,D box
...
A[1. Use live editor to create/editdiagram]
B[2. Store diagramURL somewhere]
C[3. Generate .svg fileand download toimages/ folder]
subgraph w[ ]
direction TB
D[4. Use figure shortcodeto reference .svgfile in page.md file] -->
E[5. Add caption]
end
A --> B
B --> C
...
{{< mermaid >}}
flowchart LR
A[1. Use externaltool to create/editdiagram]
B[2. If possible, savediagram coordinatesfor contributoraccess]
C[3. Generate .svg or.png fileand download toappropriateimages/ folder]
subgraph w[ ]
direction TB
D[4. Use figure shortcodeto reference svg orpng file inpage .md file] -->
E[5. Add caption]
end
A --> B
B --> C
...
{{< mermaid >}}
flowchart
A[DiagramInline Mermaid orSVG image files]
B[Diagram CaptionAdd Figure Number. andCaption Text]
C[Diagram ReferralReference Figure Numberin text]
classDef box fill:#fff,stroke:#000,stroke-width:1px,color:#000;
class A,B,C box
...
{{< /note >}}
See Methods for creating diagrams
