...
Get a list of {{< glossary_tooltip text="DeviceClasses" term_id="deviceclass" >}}:
shell
kubectl get deviceclasses
The output is similar to this:
No resources found

Get a list of  {{< glossary_tooltip text="ResourceSlices" term_id="resourceslice" >}}:
shell
kubectl get resourceslices
The output is similar to this:
No resources found

Get a list of {{< glossary_tooltip text="ResourceClaims" term_id="resourceclaim" >}} and {{<
...
Create the DeviceClass representing the device types this DRA driver
   supports:
...
Create a {{< glossary_tooltip term_id="priority-class" >}} for the DRA
...
To check how the driver handled device allocation, get the logs for the
