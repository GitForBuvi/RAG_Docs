...
Verify each identity has only the required verbs and subresources.
Confirm DRA status updates work after rollout.
Watch API server audit events for denied resourceclaims/binding and
