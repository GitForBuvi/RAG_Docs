...
(Members of OutputRoutingOptions are embedded into this type.)
...
apiVersionstringkubelet.config.k8s.io/v1beta1
...
apiVersionstringkubelet.config.k8s.io/v1beta1
kindstringKubeletConfiguration
...
apiVersionstringkubelet.config.k8s.io/v1beta1
kindstringSerializedNodeConfigSource
source
