...
| !('MY_KEY' in object.map1) || object.map1['MY_KEY'].matches('^[a-zA-Z]*$') | Validate the value of a map for a specific key, if it is in the map        |
...
Read Supported evaluation on CEL
